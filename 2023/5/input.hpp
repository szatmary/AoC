#include <cstdint>
#include <vector>
auto seeds = std::vector<uint32_t> { 194657215, 187012821, 1093203236, 6077151, 44187305, 148722449, 2959577030, 152281079, 3400626717, 198691716, 1333399202, 287624830, 2657325069, 35258407, 1913289352, 410917164, 1005856673, 850939, 839895010, 162018909 };
